...
def render_document_codegen_script(data: DocumentCodegenCapture, out_path: Path) -> str:
    ...
    lines.append("from ezdxf.dynblkhelper import remove_stale_hatch_associations")
    lines.append("from ezdxf.dynblkhelper import ensure_insert_seqends")
    lines.append("from ezdxf.dynblkhelper import sync_handseed")
    lines.append("")
