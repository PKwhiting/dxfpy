...
from dxfpy.entities.boundary_paths import (
    PolylinePath,
    EdgePath,
    LineEdge,
    ArcEdge,
...
def explode_entity(
    ...
    Returns an :class:`~dxfpy.query.EntityQuery` container with all DXF parts.
...
def _virtual_edge_path(
    ...
    from dxfpy.entities import Line, Arc, Ellipse, Spline
