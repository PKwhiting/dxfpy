...
from dxfpy.npshapes import NumpyPath2d, NumpyPoints2d

if TYPE_CHECKING:
    from dxfpy.math.clipping import Clipping
...
class ClippingRect(ClippingPolygon):
    ...
    def __init__(self, vertices: Iterable[UVec]) -> None:
        from dxfpy.math.clipping import ClippingRect2d
...
class ConvexClippingPolygon(ClippingPolygon):
    ...
    def __init__(self, vertices: Iterable[UVec]) -> None:
        from dxfpy.math.clipping import ConvexClippingPolygon2d
...
class ConcaveClippingPolygon(ClippingPolygon):
    ...
    def __init__(self, vertices: Iterable[UVec]) -> None:
        from dxfpy.math.clipping import ConcaveClippingPolygon2d
...
class InvertedClippingPolygon(ClippingPolygon):
    ...
    def __init__(self, vertices: Iterable[UVec], outer_bounds: BoundingBox2d) -> None:
        from dxfpy.math.clipping import InvertedClippingPolygon2d
