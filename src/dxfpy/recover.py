...
from dxfpy.lldxf import repair
...
from dxfpy.lldxf.tags import group_tags, Tags
...
if TYPE_CHECKING:
    ...
    from dxfpy.eztypes import SectionDict
...
def readfile(
    ...
    """Read a DXF document from file system similar to :func:`dxfpy.readfile`,
...
def read(stream: BinaryIO, errors: str = "surrogateescape") -> tuple[Drawing, Auditor]:
    """Read a DXF document from a binary-stream similar to :func:`dxfpy.read`,
