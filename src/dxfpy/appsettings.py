...
from dxfpy.enums import EndCaps, JoinStyle
...
def update_extents(doc: Drawing) -> BoundingBox:
    ...
    $EXTMIN and $EXTMAX and returns the result as :class:`dxfpy.math.BoundingBox`.
    Note that this function uses the :mod:`dxfpy.bbox` module to calculate the
    ...
    active viewport to this extents, use this recipe::
        ...
        import dxfpy
        from dxfpy import zoom, appsettings
    ...
    .. seealso::
        ...
        - the :mod:`dxfpy.bbox` module to understand the limitations of the
          extent calculation
        - the :mod:`dxfpy.zoom` module
