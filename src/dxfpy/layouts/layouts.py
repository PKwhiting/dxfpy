...
import logging
from dxfpy.lldxf.const import DXFKeyError, DXFValueError, DXFStructureError
...
if TYPE_CHECKING:
    ...
    from dxfpy.entities import Dictionary, DXFLayout
...
class Layouts:
    ...
    def __iter__(self) -> Iterator[Layout]:
        """Returns iterable of all layouts as :class:`~dxfpy.layouts.Layout`
    ...
    def new(self, name: str, dxfattribs=None) -> Paperspace:
        """Returns a new :class:`~dxfpy.layouts.Paperspace` layout.
    ...
    def modelspace(self) -> Modelspace:
        """Returns the :class:`~dxfpy.layouts.Modelspace` layout."""
    ...
    def get(self, name: Optional[str]) -> Layout:
        """Returns :class:`~dxfpy.layouts.Layout` by `name`, case-insensitive
        "Model" == "MODEL".
