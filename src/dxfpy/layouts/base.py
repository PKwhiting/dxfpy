...
from dxfpy.entities import factory, is_graphic_entity, SortEntsTable
...
from dxfpy.entitydb import EntityDB, EntitySpace
from dxfpy.graphicsfactory import CreatorInterface

if TYPE_CHECKING:
    from dxfpy.entities import DXFGraphic, BlockRecord, ExtensionDict
    from dxfpy.eztypes import KeyFunc
...
class BaseLayout(_AbstractLayout):
    ...
    def units(self) -> InsertUnits:
        ...
        drawing units`.
        """
        # todo: doesn't care about units stored in XDATA, see dxfpy/units.py
    ...
    def add_foreign_entity(self, entity: DXFGraphic, copy=True) -> None:
        ...
        :mod:`~dxfpy.addons.importer` add-on. Especially objects with BLOCK
