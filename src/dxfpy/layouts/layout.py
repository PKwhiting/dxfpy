...
from dxfpy.lldxf.validator import make_table_key
from .base import BaseLayout

if TYPE_CHECKING:
    from dxfpy.document import Drawing
    from dxfpy.layouts import BlockLayout
    from dxfpy.entities import GeoData, Viewport, DXFLayout, DXFGraphic, BlockRecord
...
class Layout(BaseLayout):
    ...
    def dxf(self) -> Any:
        ...
        :class:`~dxfpy.entities.DXFLayout` object.
    ...
    def set_plot_style(self, name: str = "dxfpy.ctb", show: bool = False) -> None:
...
class Modelspace(Layout):
    ...
    def new_geodata(self, dxfattribs=None) -> GeoData:
        ...
        :class:`~dxfpy.entities.ExtensionDict` located in BLOCK_RECORD of the
        modelspace.
    ...
    def get_geodata(self) -> Optional[GeoData]:
        """Returns the :class:`~dxfpy.entities.GeoData` entity associated to
...
class Paperspace(Layout):
    ...
    `dxfpy`, this differentiation is just for AutoCAD important and it is not
    ...
    def rename(self, name: str) -> None:
        ...
        Use method :meth:`~dxfpy.layouts.Layouts.rename` of the
        :meth:`~dxfpy.layouts.Layouts` class to rename paper space
        layouts.
    ...
    def add_viewport(
        ...
        """Add a new :class:`~dxfpy.entities.Viewport` entity.
