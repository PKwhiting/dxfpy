...
from dxfpy.lldxf.types import is_valid_handle
from dxfpy.entities.dxfentity import DXFEntity
from dxfpy.entities.dxfobj import DXFObject
from dxfpy.audit import AuditError, Auditor
from dxfpy.lldxf.const import DXFInternalEzdxfError
from dxfpy.entities import factory
from dxfpy.query import EntityQuery
from dxfpy.entities.copy import default_copy
...
class EntityDB:
    ...
    def duplicate_entity(self, entity: DXFEntity) -> DXFEntity:
        ...
        :meth:`~dxfpy.layouts.BaseLayout.add_entity`. DXF objects will
...
class EntitySpace:
    """
    An :class:`EntitySpace` is a collection of :class:`~dxfpy.entities.DXFEntity`
    objects, that stores only  references to :class:`DXFEntity` objects.

    The :class:`~dxfpy.layouts.Modelspace`, any :class:`~dxfpy.layouts.Paperspace`
    layout and :class:`~dxfpy.layouts.BlockLayout` objects have an
