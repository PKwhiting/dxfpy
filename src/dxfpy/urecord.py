...
from dxfpy.lldxf.tags import Tags, binary_data_to_dxf_tags
from dxfpy.lldxf.types import dxftag
from dxfpy.math import Vec3, Vec2
...
class UserRecord:
    def __init__(
        ...
        *,
        ...
        :class:`~dxfpy.entities.XRecord` instance if ``None``. If `doc` is not
        ...
        Args:
            xrecord (XRecord): underlying :class:`~dxfpy.entities.XRecord` instance,
    ...
    def handle(self) -> Optional[str]:
        """DXF handle of the underlying :class:`~dxfpy.entities.XRecord` instance."""
    ...
    def commit(self) -> XRecord:
        """Store :attr:`data` in the underlying :class:`~dxfpy.entities.XRecord`
...
class BinaryRecord:
    ...
    def commit(self) -> XRecord:
        """Store binary :attr:`data` in the underlying :class:`~dxfpy.entities.XRecord`
        instance. This call is not required if using the class by the ``with``
        statement.
