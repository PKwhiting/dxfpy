...
A list of :class:`~dxfpy.lldxf.types.DXFTag`, inherits from Python standard list.
...
(:class:`~dxfpy.entities.material.Material`: normal map shares group codes with
...
class Tags(list):
    """Collection of :class:`~dxfpy.lldxf.types.DXFTag` as flat list.
    ...
    def has_tag(self, code: int) -> bool:
        """Returns ``True`` if a :class:`~dxfpy.lldxf.types.DXFTag` with given
    ...
    def get_first_value(self, code: int, default: Any=DXFValueError) -> Any:
        """Returns value of first :class:`~dxfpy.lldxf.types.DXFTag` with given
    ...
    def get_first_tag(self, code: int, default=DXFValueError) -> DXFTag:
        """Returns first :class:`~dxfpy.lldxf.types.DXFTag` with given group
    ...
    def find_all(self, code: int) -> Tags:
        """Returns a list of :class:`~dxfpy.lldxf.types.DXFTag` with given
        group code.
    ...
    def tag_index(self, code: int, start: int = 0, end: Optional[int] = None) -> int:
        """Return index of first :class:`~dxfpy.lldxf.types.DXFTag` with given
        group code.
    ...
    def strip(cls, tags: Tags, codes: Iterable[int]) -> Tags:
        ...
        Args:
            tags: iterable of :class:`~dxfpy.lldxf.types.DXFTag`
            codes: iterable of group codes as int
