...
if TYPE_CHECKING:
    from dxfpy.eztypes import IterableTags
...
class ExtendedTags:
    ...
    def flatten_subclasses(self):
        ...
        works if the reader ignore subclass marker tags, unfortunately dxfpy
        tries to use this subclass markers and therefore R12 parsing by dxfpy
    ...
    def _setup(self, tags: Iterator[DXFTag]) -> None:
        ...
        def collect_base_class() -> DXFTag:
            ...
            # This special subclass is ignored by dxfpy, content is included in
        ...
        def collect_embedded_object(starttag: DXFTag) -> DXFTag:
            ...
            dxfpy does not use or modify the embedded object data, the data is
