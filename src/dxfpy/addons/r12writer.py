...
# drawing, and without dependencies to other dxfpy modules.
...
from dxfpy.lldxf.tagwriter import BinaryTagWriter
...
class R12FastStreamWriter:
    ...
    def add_polyface(
        ...
        All 3D form functions of the :mod:`dxfpy.render.forms` module return
        :class:`~dxfpy.render.MeshBuilder` objects, which provide the required
        vertex and face lists.

        See sphere example: https://github.com/mozman/dxfpy/blob/master/examples/r12writer.py
    ...
    def add_polymesh(
        ...
        See example: https://github.com/mozman/dxfpy/blob/master/examples/r12writer.py
