...
class PyQtFileOutput(FileOutputRenderBackend):
    def __init__(self, dpi: float) -> None:
        ...
        try:
            from dxfpy.addons.xqt import QtCore, QtGui, QtWidgets
            from dxfpy.addons.drawing.pyqt import PyQtBackend
        except ImportError:
...
class MuPDFFileOutput(FileOutputRenderBackend):
    def __init__(self, dpi: float) -> None:
        ...
        from dxfpy.addons.drawing.pymupdf import PyMuPdfBackend, is_pymupdf_installed
...
class SvgFileOutput(FileOutputRenderBackend):
    def __init__(self, dpi: float) -> None:
        ...
        from dxfpy.addons.drawing.svg import SVGBackend
