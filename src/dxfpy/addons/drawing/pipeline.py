...
from dxfpy.math import Vec2, Matrix44, BoundingBox2d, AnyVec
from dxfpy.path import make_path, Path
from dxfpy.render import linetypes
from dxfpy.entities import DXFGraphic, Viewport
from dxfpy.tools.text import replace_non_printable_characters
from dxfpy.tools.clipping_portal import (
    ClippingPortal,
    ClippingShape,
...
def filter_vp_entities(
    ...
    def is_visible(e):
        ...
        if entity_bbox is None:
            ...
            entity_bbox = dxfpy.bbox.extents((e,), fast=True, cache=bbox_cache)
    ...
    if not bbox_cache.has_data:
        # fill cache at once
        dxfpy.bbox.extents(msp, fast=True, cache=bbox_cache)
