...
from dxfpy.addons.drawing.backend import BackendInterface, ImageData
from dxfpy.addons.drawing.properties import (
    RenderContext,
    OLE2FRAME_COLOR,
    Properties,
    Filling,
...
from dxfpy.addons.drawing.config import BackgroundPolicy, TextPolicy
from dxfpy.addons.drawing.text import simplified_text_chunks
from dxfpy.addons.drawing.type_hints import FilterFunc
from dxfpy.addons.drawing.gfxproxy import DXFGraphicProxy
from dxfpy.addons.drawing.mtext_complex import complex_mtext_renderer
...
from dxfpy.tools import clipping_portal
from dxfpy.entities.attrib import BaseAttrib
from dxfpy.entities.polygon import DXFPolygon
from dxfpy.entities.boundary_paths import AbstractBoundaryPath
from dxfpy.entities.textstyle import get_textstyle
from dxfpy.layouts import Layout
from dxfpy.math import Vec2, Vec3, OCS, NULLVEC, Matrix44
...
from dxfpy.render import MeshBuilder, TraceBuilder
from dxfpy import reorder
from dxfpy.proxygraphic import ProxyGraphic, ProxyGraphicError
from dxfpy.protocols import SupportsVirtualEntities, virtual_entities
from dxfpy.tools.text import has_inline_formatting_codes, MIN_CAP_HEIGHT
from dxfpy.tools import text_layout
from dxfpy.lldxf import const
from dxfpy.render import hatching
from dxfpy.fonts import fonts
from dxfpy.colors import RGB, RGBA
...
POST_ISSUE_MSG = (
    "Please post sample DXF file at https://github.com/mozman/dxfpy/issues."
)
...
class UniversalFrontend:
    ...
    def __init__(
        ...
        bbox_cache: Optional[dxfpy.bbox.Cache] = None,
    ):
    ...
    def draw_layout(
        ...
        *,
        ...
        Args:
            layout: layout to draw of type :class:`~dxfpy.layouts.Layout`
...
def _find_image_path(document_dir: pathlib.Path, filename: str) -> pathlib.Path:
    ...
    # https://dxfpy.mozman.at/notes/#/page/image%20file%20paths
