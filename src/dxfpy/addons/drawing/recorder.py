...
from dxfpy.math import BoundingBox2d, Matrix44, Vec2, UVec
from dxfpy.npshapes import NumpyPath2d, NumpyPoints2d, EmptyShapeError
...
class Player:
    ...
    def bbox(self) -> BoundingBox2d:
        """Returns the bounding box of all records as :class:`~dxfpy.math.BoundingBox2d`."""
