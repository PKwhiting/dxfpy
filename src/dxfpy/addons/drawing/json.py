...
from dxfpy.math import Vec2, world_mercator_to_gps
from dxfpy.path import Command, nesting
from dxfpy.npshapes import orient_paths, single_paths
...
class CustomJSONBackend(_JSONBackend):
    ...
    https://github.com/mozman/dxfpy/blob/master/src/dxfpy/addons/drawing/json.py
...
class GeoJSONBackend(_JSONBackend):
    ...
    **package-user** to provide a function to transfrom the input coordinates to
    EPSG:4326!  The :class:`~dxfpy.addons.drawing.recorder.Recorder` and
    :class:`~dxfpy.addons.drawing.recorder.Player` classes can help to detect the
