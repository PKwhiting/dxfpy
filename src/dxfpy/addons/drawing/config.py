...
from dxfpy.enums import Measurement
...
class ProxyGraphicPolicy(Enum):
    ...
    .. note::
        ...
        Set the global option :attr:`dxfpy.options.load_proxy_graphics` to
...
class Configuration:
    ...
    Attributes:
        ...
        pdmode: point styling mode (see POINT documentation)
            ...
            see :class:`~dxfpy.entities.Point` class documentation

        measurement: whether to use metric or imperial units as enum :class:`dxfpy.enums.Measurement`
    ...
    # Keep value in sync with dxfpy.render.hatching.MIN_HATCH_LINE_DISTANCE
