...
from dxfpy.path import Command
...
class PyMuPdfBackend(recorder.Recorder):
    ...
    def get_replay(
        ...
        *,
        ...
        Args:
            page: page definition, see :class:`~dxfpy.addons.drawing.layout.Page`
            settings: layout settings, see :class:`~dxfpy.addons.drawing.layout.Settings`
