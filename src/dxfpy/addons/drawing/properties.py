...
from dxfpy.colors import RGB
from dxfpy.addons import acadctb
from dxfpy.addons.drawing.config import Configuration
from dxfpy.addons.drawing.type_hints import Color
from dxfpy.colors import DXF_DEFAULT_COLORS, int2rgb
...
from dxfpy.entities.ltype import CONTINUOUS_PATTERN
from dxfpy.entities.polygon import DXFPolygon
from dxfpy.enums import InsertUnits, Measurement
from dxfpy.filemanagement import find_support_file
from dxfpy.lldxf import const
from dxfpy.lldxf.validator import make_table_key as layer_key
from dxfpy.fonts import fonts
from dxfpy.tools.pattern import scale_pattern, HatchPatternType
...
class LayoutProperties:
    ...
    def __init__(
        ...
        Args:
            ...
            units: enum :class:`dxfpy.enums.InsertUnits`
        """
        self.name = name
...
class RenderContext:
    ...
    Args:
        doc: DXF document
        ctb: path to a plot style table or a :class:`~dxfpy.addons.acadctb.ColorDependentPlotStyles`
            instance
    ...
    def resolve_lineweight(
        ...
        see: :attr:`dxfpy.lldxf.const.VALID_DXF_LINEWEIGHTS`
