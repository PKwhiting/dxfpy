...
from dxfpy.addons.xqt import QtWidgets as qw, QtCore as qc, QtGui as qg
from dxfpy.addons.xqt import Slot, QAction, Signal
...
from dxfpy.addons.drawing.pyqt import (
    _get_x_scale,
    PyQtBackend,
...
from dxfpy.entities import DXFGraphic, DXFEntity
...
class CADWidget(qw.QWidget):
    def __init__(self, view: CADGraphicsView, config: Configuration = Configuration()):
        ...
        self._config = config
        self._bbox_cache = dxfpy.bbox.Cache()
