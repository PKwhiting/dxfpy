...
class Backend(abc.ABC):
    ...
    def draw_polyline(self, properties: Properties, points: Sequence[Vec2]) -> None:
        ...
        Args:
            ...
            points: sequence of :class:`dxfpy.math.Vec2` instances
    ...
    def draw_paths(
        ...
        single :class:`~dxfpy.path.Path` instances. Draws outline paths if
        Properties.FillType is NONE and filled paths otherwise.

        Args:
            properties: display :class:`Properties` for the filled polygon
            paths: sequence of single :class:`dxfpy.path.Path` instances
...
class Player:
    ...
    def bbox(self) -> BoundingBox2d:
        ...
        :class:`~dxfpy.math.BoundingBox2d`.
        """
