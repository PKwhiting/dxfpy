...
# Integration as dxfpy add-on, Copyright (c) 2020, Manfred Moitzi, MIT License.
from __future__ import annotations
from typing import Optional
from dxfpy.math import Vec3, best_fit_normal, normal_vector_3p
from dxfpy.render import MeshVertexMerger, MeshBuilder, MeshTransformer
...
class CSG:
    ...
    New 3D solids are created from :class:`~dxfpy.render.MeshBuilder` objects
    and results can be exported as :class:`~dxfpy.render.MeshTransformer` objects
    to `dxfpy` by method :meth:`mesh`.

    Args:
        mesh: :class:`dxfpy.render.MeshBuilder` or inherited object
    ...
    def mesh(self, meshid: int = 0) -> MeshTransformer:
        """
        Returns a :class:`dxfpy.render.MeshTransformer` object.
