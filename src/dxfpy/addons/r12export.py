...
import dxfpy
from dxfpy import const, proxygraphic, path
...
from dxfpy.layouts import BlockLayout, VirtualLayout
from dxfpy.lldxf.tagwriter import TagWriter, AbstractTagWriter
from dxfpy.lldxf.types import DXFTag, TAG_STRING_FORMAT
from dxfpy.math import Z_AXIS, Vec3, NULLVEC
from dxfpy.r12strict import R12NameTranslator
from dxfpy.render import MeshBuilder
from dxfpy.sections.table import TextstyleTable
...
def export_acad_table(exporter: R12Exporter, entity: DXFEntity) -> None:
    from dxfpy.entities.acad_table import AcadTableBlockContent
