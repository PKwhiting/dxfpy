...
from dxfpy.path import make_path, from_hatch_boundary_path, make_polygon_structure
from dxfpy.entities import DXFGraphic, LWPolyline, Point, Polyline, Line
...
def dxf_entities(
    ...
    *,
    ...
    use :attr:`PolygonConversion.HATCH` for :class:`~dxfpy.entities.Hatch` entity,
    :attr:`PolygonConversion.POLYLINE` for :class:`~dxfpy.entities.LWPolyline` or
    ...
    like a :class:`~dxfpy.entities.Hatch` entity  with additional borderlines,
...
class GeoProxy:
    ...
    def crs_to_wcs(self, crs: Matrix44) -> None:
        ...
        Args:
            crs: transformation matrix of type :class:`~dxfpy.math.Matrix44`
    ...
    def wcs_to_crs(self, crs: Matrix44) -> None:
        ...
        The CRS is defined by the :class:`~dxfpy.entities.GeoData` entity,
        get the :class:`GeoData` entity from the modelspace by method
        :meth:`~dxfpy.layouts.Modelspace.get_geodata`.
        The CRS transformation matrix can be acquired form the :class:`GeoData`
        object by :meth:`~dxfpy.entities.GeoData.get_crs_transformation` method:

        .. code:: Python

            doc = dxfpy.readfile('file.dxf')
            msp = doc.modelspace()
    ...
    def to_dxf_entities(
        ...
        *,
        ...
        use 1 for :class:`~dxfpy.entities.Hatch` entity, 2 for
        :class:`~dxfpy.entities.LWPolyline` or 3 for both.
        ...
        :class:`~dxfpy.entities.MPolygon` support was added in v0.16.6, which is
        like a :class:`~dxfpy.entities.Hatch` entity  with additional borderlines,
        but the MPOLYGON entity is not a core DXF entity and DXF viewers,
        applications and libraries my not support this entity. The DXF attribute
        `color` defines the borderline color and `fill_color` the color of the
