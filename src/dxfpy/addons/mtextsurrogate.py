...
class MTextSurrogate(SubscriptAttributes):
    ...
    added to simplify the transition from :mod:`dxfwrite` to :mod:`dxfpy`.
    ...
    the :class:`~dxfpy.addons.MTextExplode` add-on to explode the MTEXT entity
    into DXF primitives.
    ...
    Args:
        ...
        align: text alignment as :class:`~dxfpy.enums.MTextEntityAlignment` enum
        char_height: text height in drawing units
        style: :class:`~dxfpy.entities.Textstyle` name as string
    ...
    def __init__(
        ...
        self.mirror = int(mirror)  # renamed to text_generation_flag in dxfpy
