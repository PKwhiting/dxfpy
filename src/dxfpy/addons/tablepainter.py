...
from dxfpy.math import UVec, Vec2
...
class TablePainter:
    ...
    Args:
        insert: insert location as or :class:`~dxfpy.math.UVec`
        nrows: row count
        ncols: column count
...
class CellStyle:
    ...
    def __init__(self, data: Optional[dict[str, Any]] = None):
        ...
        self.stacked = False
        # text and block alignment, see dxfpy.enums.MTextEntityAlignment
    ...
    def update(self, data: dict[str, Any]):
        ...
        ), "enum dxfpy.enums.MTextEntityAlignment for text alignments required"
...
class TextCell(Cell):
    ...
    :class:`~dxfpy.addons.MTextSurrogate` add-on to render the multi-line
...
class BlockCell(Cell):
    ...
    Args:
        table: table object
        blockdef: :class:`dxfpy.layouts.BlockLayout` instance
