...
from dxfpy.filemanagement import dxf_file_info
from dxfpy.lldxf import fileindex

from dxfpy.entities import DXFGraphic, DXFEntity, Polyline, Insert
from dxfpy.entities import factory
from dxfpy.entities.subentity import entity_linker
from dxfpy.tools.codepage import toencoding
...
class IterDXF:
    ...
    def modelspace(
        ...
        modelspace. These entities are regular :class:`~dxfpy.entities.DXFGraphic`
        objects but without a valid document assigned. It is **not**
        possible to add these entities to other `dxfpy` documents.
        ...
        :class:`~dxfpy.render.MeshTransformer` class to render (recreate) this
