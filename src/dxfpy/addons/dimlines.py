...
This add-on exist just for an easy transition from `dxfwrite` to `dxfpy`.
...
.. warning::
    ...
    Try to not use these classes beside porting `dxfwrite` code to `dxfpy`
...
from dxfpy.math import Vec3, Vec2, distance, lerp, ConstructionRay, UVec
