...
# License: MIT License
# This add-on was created to solve this problem: https://github.com/mozman/dxfpy/discussions/789
...
def export_stream(doc: Drawing, stream: TextIO) -> None:
    ...
    if doc.dxfversion != dxfpy.const.DXF12:
        raise dxfpy.DXFVersionError("only DXF R12 format is supported")
    tagwriter = TagWriter(stream, write_handles=False, dxfversion=dxfpy.const.DXF12)
