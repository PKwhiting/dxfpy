...
#
# This simplifies 2D entity processing for dxfpy users and creates DXF
...
import math
from dxfpy.math import Z_AXIS, Vec3, Vec2
...
def upright(entity: DXFGraphic) -> None:
    ...
    documentation of the :mod:`dxfpy.upright` module.
