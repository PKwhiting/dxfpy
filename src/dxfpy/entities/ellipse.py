...
from dxfpy.lldxf.const import SUBCLASS_MARKER, DXF2000
...
if TYPE_CHECKING:
    ...
    from dxfpy.entities import DXFNamespace, Spline
...
class Ellipse(DXFGraphic):
    ...
    def construction_tool(self) -> ConstructionEllipse:
        """Returns construction tool :class:`dxfpy.math.ConstructionEllipse`."""
        dxf = self.dxf
    ...
    def apply_construction_tool(self, e: ConstructionEllipse) -> Ellipse:
        ...
        :class:`dxfpy.math.ConstructionEllipse`.
    ...
    def to_spline(self, replace=True) -> Spline:
        """Convert ELLIPSE to a :class:`~dxfpy.entities.Spline` entity.
