...
from dxfpy.lldxf.packedtags import VertexArray, Tags
...
if TYPE_CHECKING:
    from dxfpy.entities import DXFNamespace, Ellipse
...
class Spline(DXFGraphic):
    ...
    def control_points(self) -> Vertices:
        """:class:`~dxfpy.lldxf.packedtags.VertexArray` of control points in
        :ref:`WCS`.
        """
    ...
    def fit_points(self) -> Vertices:
        """:class:`~dxfpy.lldxf.packedtags.VertexArray` of fit points in
        :ref:`WCS`.
        """
    ...
    def construction_tool(self) -> BSpline:
        """Returns the construction tool :class:`dxfpy.math.BSpline`."""
    ...
    def apply_construction_tool(self, s) -> Spline:
        """Apply SPLINE data from a :class:`~dxfpy.math.BSpline` construction
