...
from dxfpy.lldxf.const import SUBCLASS_MARKER, DXF2000, DXFTypeError
from dxfpy.lldxf import const
from dxfpy.lldxf.tags import Tags
from dxfpy.math import NULLVEC, Z_AXIS, UVec, Matrix44, Vec3
...
class PdfReference(Underlay):
    """PDFREFERENCE ia a synonym for PDFUNDERLAY, dxfpy creates always PDFUNDERLAY
    entities.
    """
