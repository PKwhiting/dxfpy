...
from dxfpy.lldxf.const import SUBCLASS_MARKER, DXF2000, DXF2010
from dxfpy.math import Vec3, Vec2, BoundingBox2d, UVec, Matrix44
...
if TYPE_CHECKING:
    ...
    from dxfpy.entities import DXFNamespace, DXFEntity, Dictionary
...
class ImageBase(DXFGraphic):
    ...
    def boundary_path_wcs(self) -> list[Vec3]:
        ...
        It's recommended to acquire the clipping path as :class:`~dxfpy.path.Path` object
        by the :func:`~dxfpy.path.make_path` function::
...
class Image(ImageBase):
    ...
    def post_bind_hook(self) -> None:
        ...
        if self._image_def_reactor:  # ImageDefReactor already exist
            return
        # The new Image was created by dxfpy and the ImageDefReactor
