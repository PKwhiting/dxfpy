...
from dxfpy.lldxf.const import DXF12, DXF2007, DXF2000
...
class DimStyle(DXFEntity):
    ...
    def post_load_hook(self, doc: Drawing) -> None:
        ...
        # dxfpy uses names for blocks, linetypes and text style as internal
    ...
    def register_resources(self, registry: xref.Registry) -> None:
        ...
        # dxfpy uses names for blocks, linetypes and text style as internal data
        # register text style
