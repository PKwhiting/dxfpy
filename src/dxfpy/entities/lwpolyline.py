...
from dxfpy.math import Vec3, Matrix44, Z_AXIS
...
from dxfpy.lldxf.packedtags import VertexArray
from dxfpy.render.polyline import virtual_lwpolyline_entities
...
if TYPE_CHECKING:
    from dxfpy.entities import DXFNamespace, Line, Arc, DXFEntity
