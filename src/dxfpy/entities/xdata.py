...
from dxfpy.lldxf.types import dxftag, VALID_XDATA_GROUP_CODES, DXFTag
from dxfpy.lldxf.tags import Tags
from dxfpy.lldxf.const import XDATA_MARKER, DXFValueError, DXFTypeError
...
class XData:
    ...
    def get(self, appid: str) -> Tags:
        """Returns the DXF tags as :class:`~dxfpy.lldxf.tags.Tags` list
        stored by `appid`.
