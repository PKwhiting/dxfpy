...
from dxfpy.lldxf.packedtags import VertexArray, TagArray, TagList
from dxfpy.math import Matrix44, UVec, Vec3
...
class Mesh(DXFGraphic):
    ...
    @property
    def vertices(self):
        """Vertices as list like :class:`~dxfpy.lldxf.packedtags.VertexArray`.
        (read/write)
        """
    ...
    @property
    def edges(self):
        """Edges as list like :class:`~dxfpy.lldxf.packedtags.TagArray`.
        (read/write)
        """
        return self._edges
    ...
    @property
    def faces(self):
        """Faces as list like :class:`~dxfpy.lldxf.packedtags.TagList`.
        (read/write)
        """
        return self._faces
