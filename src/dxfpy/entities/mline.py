...
from dxfpy.entities.factory import register_entity
...
from dxfpy.math import NULLVEC, X_AXIS, Y_AXIS, Z_AXIS, UVec, Vec3, UCS, OCS
...
if TYPE_CHECKING:
    ...
    from dxfpy.entities import DXFNamespace, DXFEntity
...
# Editing the MLINE entity by dxfpy removes the line-break features (gaps).
...
class MLine(DXFGraphic):
    ...
    def export_entity(self, tagwriter: AbstractTagWriter) -> None:
        # dxfpy does not export MLINE entities without vertices,
    ...
    def __virtual_entities__(self) -> Iterator[DXFGraphic]:
        ...
        """
        from dxfpy.render.mline import virtual_entities
    ...
    def explode(self, target_layout: Optional[BaseLayout] = None) -> EntityQuery:
        ...
        Returns an :class:`~dxfpy.query.EntityQuery` container referencing all DXF
        primitives.
