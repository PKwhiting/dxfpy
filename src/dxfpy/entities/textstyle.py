...
from dxfpy.lldxf.const import DXF12, SUBCLASS_MARKER
...
class Textstyle(DXFEntity):
    ...
    def set_extended_font_data(
        ...
        validated by `dxfpy`. Overwrites existing data.
        """
    ...
    def make_font(
        ...
        """Returns a font abstraction :class:`~dxfpy.tools.fonts.AbstractFont`
