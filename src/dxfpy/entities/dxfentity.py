...
from dxfpy.lldxf.attributes import DXFAttr, DXFAttributes, DefSubclass
...
if TYPE_CHECKING:
    ...
    from dxfpy.entities import DXFGraphic, Insert
    from dxfpy.lldxf.attributes import DXFAttr
...
class DXFEntity:
    ...
    def new(
        ...
        """Constructor for building new entities from scratch by dxfpy.

        NEW process:

        This is a trusted environment where everything is under control of
        dxfpy respectively the package-user, it is okay to raise exception
        to show implementation errors in dxfpy or usage errors of the
        package-user.
    ...
    def post_new_hook(self):
        ...
        Called only if created by dxfpy (see :meth:`DXFEntity.new`),
    ...
    def post_bind_hook(self):
        ...
        function only when the entity was created by dxfpy.
    ...
    def has_extension_dict(self) -> bool:
        ...
        :class:`~dxfpy.entities.xdict.ExtensionDict` instance.
        """
        xdict = self.extension_dict
    ...
    def get_extension_dict(self) -> ExtensionDict:
        """Returns the existing :class:`~dxfpy.entities.xdict.ExtensionDict`
        instance.
    ...
    def new_extension_dict(self) -> ExtensionDict:
        """Create a new :class:`~dxfpy.entities.xdict.ExtensionDict` instance."""
    ...
    def discard_extension_dict(self) -> None:
        """Delete :class:`~dxfpy.entities.xdict.ExtensionDict` instance."""
        if isinstance(self.extension_dict, ExtensionDict):
            self.extension_dict.destroy()
        self.extension_dict = None

    def discard_empty_extension_dict(self) -> None:
        """Delete :class:`~dxfpy.entities.xdict.ExtensionDict` instance when empty."""
        if (
    ...
    def set_app_data(self, appid: str, tags: Iterable) -> None:
        ...
        Args:
             appid: application name as defined in the APPID table.
             tags: iterable of (code, value) tuples or :class:`~dxfpy.lldxf.types.DXFTag`
...
class DXFTagStorage(DXFEntity):
    ...
    def graphic_properties(self) -> dict[str, Any]:
        ...
        """
        from dxfpy.entities.dxfgfx import acdb_entity_group_codes
