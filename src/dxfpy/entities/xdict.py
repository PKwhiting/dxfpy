...
class ExtensionDict:
    ...
    def dictionary(self) -> Dictionary:
        """Returns the underlying :class:`~dxfpy.entities.Dictionary` object."""
        xdict = self._xdict
    ...
    @property
    def handle(self) -> str:
        """Returns the handle of the underlying :class:`~dxfpy.entities.Dictionary`
        object.
        """
    ...
    @property
    def is_alive(self):
        """Returns ``True`` if the underlying :class:`~dxfpy.entities.Dictionary`
    ...
    def update_owner(self, handle: str) -> None:
        """Update owner tag of underlying :class:`~dxfpy.entities.Dictionary`
        object.
    ...
    def destroy(self):
        """Destroy the underlying :class:`~dxfpy.entities.Dictionary` object."""
        if self.has_valid_dictionary:
            self._xdict.destroy()
        self._xdict = None

    def add_dictionary(self, name: str, hard_owned: bool = True) -> Dictionary:
        """Create a new :class:`~dxfpy.entities.Dictionary` object as
    ...
    def add_xrecord(self, name: str) -> XRecord:
        """Create a new :class:`~dxfpy.entities.XRecord` object as
        extension dictionary entry `name`.
        """
        dictionary = self.dictionary
        doc = dictionary.doc
    ...
    def add_dictionary_var(self, name: str, value: str) -> DictionaryVar:
        """Create a new :class:`~dxfpy.entities.DictionaryVar` object as
        extension dictionary entry `name`.
        """
        dictionary = self.dictionary
        doc = dictionary.doc
    ...
    def add_placeholder(self, name: str) -> Placeholder:
        """Create a new :class:`~dxfpy.entities.Placeholder` object as
        extension dictionary entry `name`.
        """
        dictionary = self.dictionary
        doc = dictionary.doc
    ...
    def link_dxf_object(self, name: str, obj: DXFObject) -> None:
        ...
        :class:`~dxfpy.layouts.BaseLayout`.
