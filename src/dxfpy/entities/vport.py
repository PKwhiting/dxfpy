...
from dxfpy.lldxf.const import DXF12, SUBCLASS_MARKER, DXF2000, DXF2007
from dxfpy.lldxf.validator import is_valid_vport_name
from dxfpy.math import Vec2, NULLVEC, Z_AXIS
from dxfpy.entities.dxfentity import base_class, SubclassProcessor, DXFEntity
from dxfpy.entities.layer import acdb_symbol_table_record
...
acdb_vport = DefSubclass(
    "AcDbViewportTableRecord",
    {
        ...
        # R2000: 331 or 441 (optional) - ignored by dxfpy
