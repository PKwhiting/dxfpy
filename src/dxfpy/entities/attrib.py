...
from dxfpy.math import NULLVEC, Vec3, Z_AXIS, OCS, Matrix44
...
from dxfpy.lldxf.types import EMBEDDED_OBJ_MARKER, EMBEDDED_OBJ_STR
from dxfpy.enums import MAP_MTEXT_ALIGN_TO_FLAGS, TextHAlign, TextVAlign
...
attrib_fields = {
    ...
    # dxfpy stores the last group code 280 as "lock_position" attribute and does
...
#   because for dxfpy is this a separated Entity.
#
