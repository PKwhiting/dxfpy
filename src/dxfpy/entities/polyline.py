...
from dxfpy.lldxf.const import DXF12, SUBCLASS_MARKER, VERTEXNAMES
from dxfpy.lldxf import const
from dxfpy.math import Vec3, Matrix44, NULLVEC, Z_AXIS, UVec
from dxfpy.math.transformtools import OCSTransform, NonUniformScalingError
from dxfpy.render.polyline import virtual_polyline_entities
...
if TYPE_CHECKING:
    ...
    from dxfpy.entities import DXFNamespace, Line, Arc, Face3d
    from dxfpy.layouts import BaseLayout
    from dxfpy.lldxf.tagwriter import AbstractTagWriter
    from dxfpy.eztypes import FaceType
...
class Polyline(LinkedEntities):
    ...
    def explode(self, target_layout: Optional[BaseLayout] = None) -> EntityQuery:
        ...
        Returns an :class:`~dxfpy.query.EntityQuery` container referencing all
        DXF primitives.
