...
from dxfpy.lldxf.const import DXFAttributeError, DIMJUST, DIMTAD
from dxfpy.math import Vec3, UVec, UCS
from dxfpy.render.arrows import ARROWS

if TYPE_CHECKING:
    from dxfpy.document import Drawing
    from dxfpy.entities import DimStyle, Dimension
    from dxfpy.render.dim_base import BaseDimensionRenderer
...
class DimStyleOverride:
    def __init__(self, dimension: Dimension, override: Optional[dict] = None):
        ...
        # Special dxfpy attributes beyond the DXF reference, therefore not
    ...
    def set_tolerance(
        ...
        Args:
            ...
            hfactor: tolerance text height factor in relation to the dimension
                text height
            align: tolerance text alignment enum :class:`dxfpy.enums.MTextLineAlignment`
    ...
    def render(self, ucs: Optional[UCS] = None, discard=False) -> BaseDimensionRenderer:
        ...
        Args:
            ...
            discard: discard the content BLOCK created by `dxfpy`, this works for
