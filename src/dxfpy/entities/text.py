...
from dxfpy.math import Vec3, UVec, Matrix44, NULLVEC, Z_AXIS
from dxfpy.math.transformtools import OCSTransform
from dxfpy.audit import Auditor
from dxfpy.tools.text import plain_text
...
class Text(DXFGraphic):
    ...
    def remove_field(self, key: str = "TEXT", *, text: Optional[str] = None) -> None:
        """Remove a linked ``FIELD`` from this text entity.

        Args:
            key: dictionary entry key in the nested ``ACAD_FIELD`` dictionary
            text: optional static replacement text
    ...
    def set_placement(
        ...
        Args:
            ...
            align: new alignment as enum :class:`~dxfpy.enums.TextEntityAlignment`,
    ...
    def get_placement(self) -> tuple[TextEntityAlignment, Vec3, Optional[Vec3]]:
        ...
        enum :class:`~dxfpy.enum.TextEntityAlignment`, `p1` is the
    ...
    def set_align_enum(self, align=TextEntityAlignment.LEFT) -> Text:
        ...
        Args:
            align: :class:`~dxfpy.enums.TextEntityAlignment`
    ...
    def get_align_enum(self) -> TextEntityAlignment:
        """Returns the current text alignment as :class:`~dxfpy.enums.TextEntityAlignment`,
