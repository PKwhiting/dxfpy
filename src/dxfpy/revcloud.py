...
import math
from dxfpy.math import UVec, Vec2, has_clockwise_orientation
from dxfpy.entities import LWPolyline, DXFEntity
...
def points(
    ...
    *,
    ...
    """Returns the points for a :class:`~dxfpy.entities.LWPolyline` entity to render a
...
def add_entity(
    ...
    *,
    ...
    """Adds a revision cloud as :class:`~dxfpy.entities.LWPolyline` entity to `layout`,
