...
def from_hatch_boundary_path(
    ...
    """Returns a :class:`Path` object from a :class:`~dxfpy.entities.Hatch`
...
def from_hatch_edge_path(
    ...
    def arc(edge: ArcEdge):
        ...
        # See: dxfpy.entities.boundary_paths.ArcEdge.load_tags()
        ellipse = ConstructionEllipse.from_arc(
    ...
    def ellipse(edge: EllipseEdge):
        ...
        # See: dxfpy.entities.boundary_paths.EllipseEdge.load_tags()
...
def to_lwpolylines(
    ...
    *,
    ...
    """Convert the given `paths` into :class:`~dxfpy.entities.LWPolyline`
    entities.
    ...
    Returns:
        iterable of :class:`~dxfpy.entities.LWPolyline` objects
...
def to_polylines2d(
    ...
    *,
    ...
    """Convert the given `paths` into 2D :class:`~dxfpy.entities.Polyline`
    entities.
    The `extrusion` vector is applied to all paths, all vertices are projected
    onto the plane normal to this extrusion vector. The default extrusion vector
    is the WCS z-axis. The plane elevation is the distance from the WCS origin
    ...
    Returns:
        iterable of 2D :class:`~dxfpy.entities.Polyline` objects
...
def to_hatches(
    ...
    *,
    ...
    """Convert the given `paths` into :class:`~dxfpy.entities.Hatch` entities.
    ...
    Returns:
        iterable of :class:`~dxfpy.entities.Hatch` objects
...
def to_mpolygons(
    ...
    *,
    ...
    """Convert the given `paths` into :class:`~dxfpy.entities.MPolygon` entities.
    ...
    Returns:
        iterable of :class:`~dxfpy.entities.MPolygon` objects
...
def to_polylines3d(
    ...
    *,
    ...
    """Convert the given `paths` into 3D :class:`~dxfpy.entities.Polyline`
    entities.
    ...
    Returns:
        iterable of 3D :class:`~dxfpy.entities.Polyline` objects
...
def to_lines(
    ...
    *,
    ...
    """Convert the given `paths` into :class:`~dxfpy.entities.Line` entities.
    ...
    Returns:
        iterable of :class:`~dxfpy.entities.Line` objects
...
def to_bsplines_and_vertices(path: Path, g1_tol: float = G1_TOL) -> Iterator[PathParts]:
    ...
    Returns:
        :class:`~dxfpy.math.BSpline` and lists of :class:`~dxfpy.math.Vec3`

    """
    from dxfpy.math import bezier_to_bspline
...
def to_splines_and_polylines(
    ...
    *,
    ...
    """Convert the given `paths` into :class:`~dxfpy.entities.Spline` and 3D
    :class:`~dxfpy.entities.Polyline` entities.
