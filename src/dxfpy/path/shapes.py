...
def ngon(
    ...
    The base geometry is created by function :func:`dxfpy.render.forms.ngon`.
...
def star(count: int, r1: float, r2: float, transform: Matrix44 | None = None) -> Path:
    ...
    The base geometry is created by function :func:`dxfpy.render.forms.star`.
...
def gear(
    ...
    a :class:`Path` object, with the center at (0, 0, 0).
    The base geometry is created by function :func:`dxfpy.render.forms.gear`.
