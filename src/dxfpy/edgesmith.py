...
The complementary module to dxfpy.edgeminer.
...
from dxfpy import entities as et
from dxfpy import path
from dxfpy.entities import boundary_paths as bp
from dxfpy.upright import upright_all
...
def is_pure_2d_entity(entity: et.DXFEntity) -> bool:
    ...
    - Entities with inverted extrusions vectors (0, 0, -1) are **not** pure 2D entities.
      The dxfpy.upright module can be used to revert inverted extrusion vectors
      back to (0, 0, 1).
...
def filter_edge_entities(entities: Iterable[et.DXFEntity]) -> Iterator[et.DXFEntity]:
    ...
    .. note::
        ...
        - CIRCLE, TRACE and SOLID are closed shapes by definition and cannot be used as
          edge in the context of :mod:`dxfpy.edgeminer` or :mod:`dxfpy.edgesmith`.
...
def filter_open_edges(entities: Iterable[et.DXFEntity]) -> Iterator[et.DXFEntity]:
    ...
    :mod:`dxfpy.edgeminer` or :mod:`dxfpy.edgesmith`.
...
def lwpolyline_from_chain(
    ...
    *,
    ...
    """Returns a new virtual :class:`~dxfpy.entities.LWPolyline` entity.
    ...
    onto the xy-plane of the :ref:`WCS`.
        ...
        - :class:`~dxfpy.entities.Line` as line segment
        - :class:`~dxfpy.entities.Arc` as bulge
        - :class:`~dxfpy.entities.Ellipse` as bulge or as flattened line segments
        - :class:`~dxfpy.entities.Spline` as flattened line segments
        - :class:`~dxfpy.entities.LWPolyline` and :class:`~dxfpy.entities.Polyline`
          will be merged
...
def polyline_path_from_chain(
    ...
    """Returns a new :class:`~dxfpy.entities.PolylinePath` for :class:`~dxfpy.entities.Hatch`
    entities.
    ...
    the xy-plane of the :ref:`WCS`.
        ...
        - :class:`~dxfpy.entities.Line` as line segment
        - :class:`~dxfpy.entities.Arc` as bulge
        - :class:`~dxfpy.entities.Ellipse` as bulge or flattened line segments
        - :class:`~dxfpy.entities.Spline` as flattened line segments
        - :class:`~dxfpy.entities.LWPolyline` and :class:`~dxfpy.entities.Polyline` are
          merged
        - Everything else will be added as line segment from :attr:`Edge.start` to
          :attr:`Edge.end`
        - Gaps between edges are connected by line segments.
    ...
    Args:
        edges: Sequence of :class:`~dxfpy.edgeminer.Edge` instances with DXF primitives
            attached as payload
...
def edge_path_from_chain(
    ...
    """Returns a new :class:`~dxfpy.entities.EdgePath` for :class:`~dxfpy.entities.Hatch`
    entities.
    ...
    the xy-plane of the :ref:`WCS`.
        ...
        - :class:`~dxfpy.entities.Line` as :class:`~dxfpy.entities.LineEdge`
        - :class:`~dxfpy.entities.Arc` as :class:`~dxfpy.entities.ArcEdge`
        - :class:`~dxfpy.entities.Ellipse` as :class:`~dxfpy.entities.EllipseEdge`
        - :class:`~dxfpy.entities.Spline` as :class:`~dxfpy.entities.SplineEdge`
        - :class:`~dxfpy.entities.LWPolyline` and :class:`~dxfpy.entities.Polyline` will
          be exploded and added as :class:`~dxfpy.entities.LineEdge` and
          :class:`~dxfpy.entities.ArcEdge`
        - Everything else will be added as line segment from :attr:`Edge.start` to
          :attr:`Edge.end`
        - Gaps between edges are connected by line segments.
...
def path2d_from_chain(edges: Sequence[em.Edge]) -> path.Path:
    """Returns a new :class:`dxfpy.path.Path` entity.
    ...
    onto the xy-plane of the :ref:`WCS`.
        ...
        - :class:`~dxfpy.entities.Line` as line segment
        - :class:`~dxfpy.entities.Arc` as cubic Bézier curves
        - :class:`~dxfpy.entities.Ellipse` as cubic Bézier curves
        - :class:`~dxfpy.entities.Spine` cubic Bézier curves
        - :class:`~dxfpy.entities.LWPolyline` and :class:`~dxfpy.entities.Polyline`
...
def bounding_box_2d(edges: Sequence[em.Edge]) -> BoundingBox2d:
    """Returns the :class:`~dxfpy.math.BoundingBox2d` of all start- and end vertices."""
...
def is_inside_polygon_2d(
    ...
    Args:
        edges: sequence of :class:`~dxfpy.edgeminer.Edge` representing a closed loop
        point: point to test
