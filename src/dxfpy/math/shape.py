...
import math
from dxfpy.math import Vec2, UVec, Matrix44
...
class Shape2d:
    ...
    def offset(self, offset: float, closed: bool = False) -> Shape2d:
        ...
        :func:`dxfpy.math.offset_vertices_2d` function.
        ...
        """
        from dxfpy.math.offset2d import offset_vertices_2d
    ...
    def convex_hull(self) -> Shape2d:
        ...
        from dxfpy.math.construct2d import convex_hull_2d
