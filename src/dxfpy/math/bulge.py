...
def bulge_to_arc(
    ...
    The arcs defined by bulge values of :class:`~dxfpy.entities.LWPolyline`
    and 2D :class:`~dxfpy.entities.Polyline` entities start at the vertex which
...
def bulge_from_radius_and_chord(radius: float, chord: float) -> float:
    ...
    """
    # https://github.com/mozman/dxfpy/discussions/758
    try:
        x = chord / (2.0 * radius)
