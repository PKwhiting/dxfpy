...
from dxfpy.math.linalg import cubic_equation
...
def quadratic_to_cubic_bezier(curve: Bezier3P) -> Bezier4P:
    """Convert quadratic Bèzier curves (:class:`dxfpy.math.Bezier3P`) into
    cubic Bèzier curves (:class:`dxfpy.math.Bezier4P`).
...
def cubic_bezier_bbox(curve: Bezier4P, *, abs_tol=1e-12) -> BoundingBox:
    """Returns the :class:`~dxfpy.math.BoundingBox` of a cubic Bézier curve
    of type :class:`~dxfpy.math.Bezier4P`.
    """
...
def quadratic_bezier_bbox(curve: Bezier3P, *, abs_tol=1e-12) -> BoundingBox:
    """Returns the :class:`~dxfpy.math.BoundingBox` of a quadratic Bézier curve
    of type :class:`~dxfpy.math.Bezier3P`.
    """
