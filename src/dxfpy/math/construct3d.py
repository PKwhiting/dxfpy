...
def is_planar_face(face: Sequence[Vec3], abs_tol=1e-9) -> bool:
    ...
    Args:
         face: sequence of :class:`~dxfpy.math.Vec3` objects
...
def intersection_line_line_3d(
    ...
    """
    from dxfpy.math import intersection_ray_ray_3d, BoundingBox
...
def _is_intersection_point_inside_3d_polygon(
    ...
    from dxfpy.math import is_point_in_polygon_2d, OCS
...
def has_matrix_3d_stretching(m: Matrix44) -> bool:
    ...
    :class:`~dxfpy.math.Matrix44` property :attr:`~dxfpy.math.Matrix44.is_cartesian`
    for that.
    """
