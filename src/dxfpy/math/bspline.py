...
def fit_points_to_cad_cv(
    ...
    """
    # See also Spline class in dxfpy/entities/spline.py:
...
def fit_points_to_cubic_bezier(fit_points: Iterable[UVec]) -> BSpline:
    ...
    from dxfpy.math import cubic_bezier_interpolation, bezier_to_bspline
...
def global_bspline_interpolation(
    ...
    function :func:`~dxfpy.math.estimate_end_tangent_magnitude` helps with an
...
class BSpline:
    ...
    def control_points(self) -> Sequence[Vec3]:
        """Control points as tuple of :class:`~dxfpy.math.Vec3`"""
