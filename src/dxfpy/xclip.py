...
from dxfpy.entities import SpatialFilter, DXFEntity, Dictionary, Insert, XRecord
from dxfpy.math import Vec2, Vec3, UVec, Z_AXIS, Matrix44, BoundingBox2d
...
class ClippingPath:
    ...
    sequence of :class:`~dxfpy.math.Vec2`.
...
class XClip:
    ...
    def set_block_clipping_path(self, vertices: Iterable[UVec]) -> None:
        ...
        # The clipping path set by dxfpy is always relative to the block origin and
...
def _get_inverted_clip_compare_vertices(
    ...
    from dxfpy.math.clipping import make_inverted_clipping_polygon
