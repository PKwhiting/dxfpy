...
from dxfpy import ARROWS
from dxfpy.entities import factory
from dxfpy.lldxf.const import BYBLOCK
from dxfpy.math import Vec3, fit_points_to_cad_cv

if TYPE_CHECKING:
    from dxfpy.entities import DXFGraphic, Leader, Insert, Spline, Dimension, Line
...
def virtual_entities(leader: Leader) -> Iterator[DXFGraphic]:
    ...
    if len(vertices) < 2:
        ...
        # ignored at exporting, if created by an dxfpy-user (log).
