...
import math
from dxfpy.math import Vec3, Vec2, UVec, ConstructionRay, UCS
...
class LinearDimension(BaseDimensionRenderer):
    ...
    def __init__(
        ...
        if measurement.text_movement_rule == 0:
            ...
            # for dxfpy (just set `base` argument)
        ...
        if measurement.text:
            ...
            if self.multi_point_mode:
                # dxfpy has total control about vertical text position in multi
                # point mode
