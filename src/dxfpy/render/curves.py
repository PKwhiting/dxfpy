...
def random_2d_path(
    ...
    """Returns a random 2D path as iterable of :class:`~dxfpy.math.Vec2`
    objects.
...
def random_3d_path(
    ...
    """Returns a random 3D path as iterable of :class:`~dxfpy.math.Vec3`
    objects.
...
class Bezier:
    """Render a bezier curve as 2D/3D :class:`~dxfpy.entities.Polyline`.
    ...
    .. seealso::
        ...
        The new :mod:`dxfpy.path` package provides many advanced construction tools
        based on the :class:`~dxfpy.path.Path` class.
    ...
    def render(
        ...
        """Render Bezier curve as 2D/3D :class:`~dxfpy.entities.Polyline`.

        Args:
            layout: :class:`~dxfpy.layouts.BaseLayout` object
            force3d: force 3D polyline rendering
            dxfattribs: DXF attributes for :class:`~dxfpy.entities.Polyline`
...
class Spline:
    ...
    approximated :class:`~dxfpy.entities.Polyline` entities.
    ...
    .. seealso::
        ...
        The newer :class:`~dxfpy.math.BSpline` class provides the
        advanced vertex interpolation method :meth:`~dxfpy.math.BSpline.flattening`.
    ...
    def render_as_fit_points(
        ...
        """Render a B-spline as 2D/3D :class:`~dxfpy.entities.Polyline`, where
        the definition points are fit points.

           - 2D spline vertices uses: :meth:`~dxfpy.layouts.BaseLayout.add_polyline2d`
           - 3D spline vertices uses: :meth:`~dxfpy.layouts.BaseLayout.add_polyline3d`
    ...
    def render_open_bspline(
        ...
        """Render an open uniform B-spline as 3D :class:`~dxfpy.entities.Polyline`.
    ...
    def render_uniform_bspline(
        ...
        """Render a uniform B-spline as 3D :class:`~dxfpy.entities.Polyline`.
        Definition points are control points.
    ...
    def render_closed_bspline(
        ...
        """Render a closed uniform B-spline as 3D :class:`~dxfpy.entities.Polyline`.
        Definition points are control points.
    ...
    def render_open_rbspline(
        ...
        """Render a rational open uniform BSpline as 3D :class:`~dxfpy.entities.Polyline`.
        Definition points are control points.
    ...
    def render_uniform_rbspline(
        ...
        """Render a rational uniform B-spline as 3D :class:`~dxfpy.entities.Polyline`.
        Definition points are control points.
    ...
    def render_closed_rbspline(
        ...
        """Render a rational B-spline as 3D :class:`~dxfpy.entities.Polyline`.
        Definition points are control points.
...
class EulerSpiral:
    ...
    as a 3D :class:`~dxfpy.entities.Polyline` or a
    :class:`~dxfpy.entities.Spline` entity.
    ...
    def render_polyline(
        ...
        """Render curve as :class:`~dxfpy.entities.Polyline`.
        ...
        Args:
            ...
            matrix: transformation matrix as :class:`~dxfpy.math.Matrix44`
            dxfattribs: DXF attributes for :class:`~dxfpy.entities.Polyline`

        Returns:
            :class:`~dxfpy.entities.Polyline`
    ...
    def render_spline(
        ...
        """
        Render curve as :class:`~dxfpy.entities.Spline`.
        ...
        Args:
            ...
            matrix: transformation matrix as :class:`~dxfpy.math.Matrix44`
            dxfattribs: DXF attributes for :class:`~dxfpy.entities.Spline`

        Returns:
            :class:`~dxfpy.entities.Spline`
