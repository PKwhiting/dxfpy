...
from dxfpy.entities import DimStyleOverride, Dimension, DXFEntity
...
from dxfpy.tools.text import is_upside_down_text_angle
from dxfpy.math import intersection_line_line_2d
...
class _CurvedDimensionLine(BaseDimensionRenderer):
    ...
    def setup_text_location(self) -> None:
        ...
        if at_default_location and has_text_shifting:
            # Apply text relative shift (dxfpy only feature)
