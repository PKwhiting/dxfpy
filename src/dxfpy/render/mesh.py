...
if TYPE_CHECKING:
    from dxfpy.entities import Polyface, Polymesh, Mesh, Solid3d
...
class MeshDiagnose:
    ...
    def vertices(self) -> Sequence[Vec3]:
        """Sequence of mesh vertices as :class:`~dxfpy.math.Vec3` instances"""
    ...
    def bbox(self) -> BoundingBox:
        """Returns the :class:`~dxfpy.math.BoundingBox` of the mesh. (cached data)"""
    ...
    def estimate_face_normals_direction(self) -> float:
        ...
        here some examples for surfaces created by :mod:`dxfpy.render.forms`
        functions:

            - :func:`~dxfpy.render.forms.cube` returns 1.0
            - :func:`~dxfpy.render.forms.cylinder` returns 0.9992
            - :func:`~dxfpy.render.forms.sphere` returns 0.9994
            - :func:`~dxfpy.render.forms.cone` returns 0.9162
            - :func:`~dxfpy.render.forms.cylinder` with all hull faces pointing
            ...
            - and the estimation of 0.0469 for a :func:`~dxfpy.render.forms.torus`
              is barely usable
...
class MeshBuilder:
    ...
    def bbox(self) -> BoundingBox:
        """Returns the :class:`~dxfpy.math.BoundingBox` of the mesh."""
    ...
    def get_face_vertices(self, index: int) -> Sequence[Vec3]:
        """Returns the face `index` as sequence of :class:`~dxfpy.math.Vec3`
        objects.
        """
    ...
    def get_face_normal(self, index: int) -> Vec3:
        """Returns the normal vector of the face `index` as :class:`~dxfpy.math.Vec3`,
    ...
    def add_face(self, vertices: Iterable[UVec]) -> None:
        ...
        :class:`~dxfpy.math.Vec3` object. The new vertex indices are stored as
    ...
    def add_vertices(self, vertices: Iterable[UVec]) -> Face:
        ...
        or a :class:`~dxfpy.math.Vec3` object, returns the indices of the
    ...
    def add_mesh(
        ...
        :class:`~dxfpy.entities.Mesh` object or requires the attributes
        :attr:`vertices` and :attr:`faces`.

        Args:
            vertices: list of vertices, a vertex is a ``(x, y, z)`` tuple or
                :class:`~dxfpy.math.Vec3` object
    ...
    def render_mesh(
        ...
        """Render mesh as :class:`~dxfpy.entities.Mesh` entity into `layout`.

        Args:
            layout: :class:`~dxfpy.layouts.BaseLayout` object
            dxfattribs: dict of DXF attributes e.g. ``{'layer': 'mesh', 'color': 7}``
            matrix: transformation matrix of type :class:`~dxfpy.math.Matrix44`
            ucs: transform vertices by :class:`~dxfpy.math.UCS` to :ref:`WCS`
    ...
    def render_normals(
        ...
        """Render face normals as :class:`~dxfpy.entities.Line` entities into
    ...
    def from_mesh(cls: Type[T], other: Union[MeshBuilder, Mesh]) -> T:
        ...
        Args:
            other: `mesh` of type :class:`MeshBuilder` and inherited or DXF
                :class:`~dxfpy.entities.Mesh` entity or any object providing
    ...
    def from_polyface(cls: Type[T], other: Union[Polymesh, Polyface]) -> T:
        """Create new mesh from a  :class:`~dxfpy.entities.Polyface` or
        :class:`~dxfpy.entities.Polymesh` object.
    ...
    def render_polyface(
        ...
        """Render mesh as :class:`~dxfpy.entities.Polyface` entity into
        `layout`.
    ...
    def render_3dsolid(self, layout: GenericLayoutType, dxfattribs=None) -> Solid3d:
        """Render mesh as :class:`~dxfpy.entities.Solid3d` entity into `layout`.
    ...
    def render_3dfaces(
        ...
        """Render mesh as :class:`~dxfpy.entities.Face3d` entities into
        `layout`.
    ...
    def subdivide_ngons(self, max_vertex_count=4) -> Iterator[Sequence[Vec3]]:
        """Yields all faces as sequence of :class:`~dxfpy.math.Vec3` instances,
    ...
    def tessellation(self, max_vertex_count: int = 4) -> Iterator[Sequence[Vec3]]:
        ...
        """
        from dxfpy.math.triangulation import mapbox_earcut_3d
...
class MeshTransformer(MeshBuilder):
    ...
    def transform(self, matrix: Matrix44):
        ...
        Args:
            matrix: 4x4 transformation matrix as :class:`~dxfpy.math.Matrix44`
                object
...
class MeshVertexMerger(MeshBuilder):
    ...
    def index(self, vertex: UVec) -> int:
        ...
        Args:
            vertex: ``(x, y, z)`` tuple or :class:`~dxfpy.math.Vec3` object
