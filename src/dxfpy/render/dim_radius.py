...
from dxfpy.math import Vec2, UCS, UVec
from dxfpy.tools import normalize_text_angle
from dxfpy.render.arrows import ARROWS, connection_point
from dxfpy.entities.dimstyleoverride import DimStyleOverride
from dxfpy.lldxf.const import DXFInternalEzdxfError
from dxfpy.render.dim_base import (
...
if TYPE_CHECKING:
    from dxfpy.entities import Dimension
