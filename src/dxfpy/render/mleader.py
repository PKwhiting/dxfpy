...
from dxfpy.render.arrows import ARROWS, arrow_length
from dxfpy.tools import text_size, text as text_tools
...
class MultiLeaderBuilder(abc.ABC):
    ...
    def multileader(self) -> MultiLeader:
        """Returns the :class:`~dxfpy.entities.MultiLeader` entity."""
        return self._multileader

    @property
    def context(self) -> MLeaderContext:
        """Returns the context entity :class:`~dxfpy.entities.MLeaderContext`."""
    ...
    def set_mleader_style(self, style: MLeaderStyle):
        """Reset base properties by :class:`~dxfpy.entities.MLeaderStyle`
    ...
    def build(
        ...
        the xy-plane of the given render :class:`~dxfpy.math.UCS`.
        ...
        Args:
            ...
            ucs: the render :class:`~dxfpy.math.UCS`, default is the :ref:`WCS`
...
# is OK, also the rendering by the dxfpy multileader RenderEngine.
...
class MultiLeaderMTextBuilder(MultiLeaderBuilder):
    ...
    def set_content(
        ...
        Args:
            ...
            style: name of :class:`~dxfpy.entities.Textstyle` as string
    ...
    def quick_leader(
        ...
        Args:
            ...
            ucs: the rendering :class:`~dxfpy.math.UCS`, default is the :ref:`WCS`
