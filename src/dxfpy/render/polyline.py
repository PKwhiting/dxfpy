...
from dxfpy.lldxf.const import VERTEXNAMES
from dxfpy.math import Vec3, bulge_to_arc, OCS

if TYPE_CHECKING:
    from dxfpy.entities import LWPolyline, Polyline, Line, Arc, Face3d, Polymesh
