...
class DimensionLine:
    ...
    def __init__(self, dim_style: DimStyleOverride, default_color: int, scale: float):
        ...
        # not supported yet - dxfpy behaves like option 1
...
class Arrows:
    def __init__(self, dim_style: DimStyleOverride, color: int, scale: float):
        ...
        self.suppress1 = False  # dxfpy only
        self.suppress2 = False  # dxfpy only
...
class Measurement:
    def __init__(
        ...
        # dxfpy specific attributes beyond DXF reference, therefore not stored
        ...
        # End of dxfpy specific attributes

        get = dim_style.get
        # dxfpy locates attachment points always in the text center.
        # Fixed predefined value for dxfpy rendering:
        ...
        # 3 = JIS;
        # 4 = below
        # Options 2, 3 are ignored by dxfpy
        ...
        # text_rotation is 0 if dimension text is 'inside', dxfpy defines
        # 'inside' as at the default text location:
        self.text_inside_horizontal: bool = get("dimtih", 0)

        # text_rotation is 0 if dimension text is 'outside', dxfpy defines
        ...
        # not supported - dxfpy behaves like 2
    ...
    def location_override(self, location: UVec, leader=False, relative=False) -> None:
        """Set user defined dimension text location. dxfpy defines a user
...
class BaseDimensionRenderer:
    ...
    def __init__(
        ...
        # non arrow ticks. These are dxfpy specific attributes!
