...
from dxfpy.render.mesh import MeshVertexMerger, MeshTransformer
...
def circle(
    ...
    Returns:
        vertices in counter-clockwise orientation as :class:`~dxfpy.math.Vec3`
        objects
...
def euler_spiral(
    ...
    Returns:
        vertices as :class:`~dxfpy.math.Vec3` objects
...
def close_polygon(
    ...
    """Returns list of :class:`~dxfpy.math.Vec3`, where the first vertex is
...
def cube(center: bool = True) -> MeshTransformer:
    ...
    :class:`~dxfpy.render.MeshTransformer` object.

    Args:
        center: 'mass' center of cube, ``(0, 0, 0)`` if ``True``, else first
            corner at ``(0, 0, 0)``

    Returns: :class:`~dxfpy.render.MeshTransformer`
...
def cylinder(
    ...
    *,
    ...
    :class:`~dxfpy.render.MeshTransformer` object, the base center is fixed in
    the origin (0, 0, 0).
...
def cylinder_2p(
    ...
    *,
    ...
    :class:`~dxfpy.render.MeshTransformer` object from two points,
...
def from_profiles_linear(
    ...
    *,
    ...
    """Returns a :class:`~dxfpy.render.MeshTransformer` instance from linear
    connected `profiles`.
...
def from_profiles_spline(
    ...
    *,
    ...
    """Returns a :class:`~dxfpy.render.MeshTransformer` instance by spline
...
def cone_2p(
    ...
    *,
    ...
    """Create a `cone <https://en.wikipedia.org/wiki/Cone>`_ as
    :class:`~dxfpy.render.MeshTransformer` object from two points, `base_center`
...
def rotation_form(
    ...
    *,
    ...
    """Returns a :class:`~dxfpy.render.MeshTransformer` instance created by
...
def sphere(
    ...
    :class:`~dxfpy.render.MeshTransformer` object, the center of the sphere is
    always at (0, 0, 0).
...
def torus(
    ...
    *,
    ...
    :class:`~dxfpy.render.MeshTransformer` object, the center of the torus is
...
def sweep(
    ...
    *,
    ...
    Returns the mesh as :class:`dxfpy.render.MeshTransformer` object.
