...
from dxfpy.entities.table import TableHead
...
class LayerTable(Table[Layer]):
    ...
    def add(
        ...
        *,
        ...
        """Add a new :class:`~dxfpy.entities.Layer`.

        Args:
            name (str): layer name
            color (int): :ref:`ACI` value, default is BYLAYER
            true_color (int): true color value, use :func:`dxfpy.rgb2int` to
    ...
    def add(
        ...
        *,
        ...
        .. seealso::
            ...
            - `Tutorial for simple line types <https://dxfpy.mozman.at/docs/tutorials/linetypes.html>`_
            - `Tutorial for complex line types <https://dxfpy.mozman.at/docs/tutorials/linetypes.html#tutorial-for-complex-linetypes>`_
...
class ViewportTable(Table[VPort]):
    ...
    def get_config(self, name: str) -> list[VPort]:
        """Returns a list of :class:`~dxfpy.entities.VPort` objects, for
    ...
    def delete_config(self, name: str) -> None:
        """Delete all :class:`~dxfpy.entities.VPort` objects of the
