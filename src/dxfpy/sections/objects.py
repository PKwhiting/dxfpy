...
from dxfpy.entities.dictionary import Dictionary
from dxfpy.entities import factory, is_dxf_object
from dxfpy.lldxf import const, validator
from dxfpy.entitydb import EntitySpace, EntityDB
from dxfpy.query import EntityQuery
from dxfpy.tools.handle import UnderlayKeyGenerator
...
class ObjectsSection:
    ...
    def add_dictionary(self, owner: str = "0", hard_owned: bool = True) -> Dictionary:
        """Add new :class:`~dxfpy.entities.Dictionary` object.
    ...
    def add_dictionary_with_default(
        ...
        """Add new :class:`~dxfpy.entities.DictionaryWithDefault` object.
    ...
    def add_dictionary_var(self, owner: str = "0", value: str = "") -> DictionaryVar:
        """Add a new :class:`~dxfpy.entities.DictionaryVar` object.
    ...
    def add_xrecord(self, owner: str = "0") -> XRecord:
        """Add a new :class:`~dxfpy.entities.XRecord` object.
    ...
    def add_field(self, owner: str = "0", dxfattribs: Optional[dict] = None) -> Field:
        """Add a new :class:`~dxfpy.entities.Field` object.
    ...
    def add_placeholder(self, owner: str = "0") -> Placeholder:
        """Add a new :class:`~dxfpy.entities.Placeholder` object.
    ...
    def set_raster_variables(
        ...
        (internal API), public interface :meth:`~dxfpy.drawing.Drawing.set_raster_variables`
    ...
    def add_image_def(
        ...
        determine the image size by itself. Returns a :class:`~dxfpy.entities.image.ImageDef`
    ...
    def add_underlay_def(
        ...
        """Add an :class:`~dxfpy.entities.underlay.UnderlayDefinition` entity
    ...
    def add_geodata(self, owner: str = "0", dxfattribs=None) -> GeoData:
        ...
        Args:
            owner: handle to owner as hex string
            dxfattribs: DXF attributes for :class:`~dxfpy.entities.GeoData` entity
