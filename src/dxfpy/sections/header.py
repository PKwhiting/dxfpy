...
from dxfpy.lldxf.tags import group_tags, Tags, DXFTag
from dxfpy.lldxf.types import strtag
from dxfpy.lldxf.validator import header_validator
from dxfpy.sections.headervars import (
    HEADER_VAR_MAP,
...
class CustomVars:
    ...
    or later, `dxfpy` can create custom properties for older DXF versions as well, but
