...
class BlocksSection:
    ...
    def __delitem__(self, name: str) -> None:
        """Deletes :class:`~dxfpy.layouts.BlockLayout` `name` and all of
    ...
    def get(self, name: str, default=None) -> BlockLayout:
        """Returns :class:`~dxfpy.layouts.BlockLayout` `name`, returns
    ...
    def new(
        ...
        """Create and add a new :class:`~dxfpy.layouts.BlockLayout`, `name`
    ...
    def new_anonymous_block(
        ...
        """Create and add a new anonymous :class:`~dxfpy.layouts.BlockLayout`,
    ...
    def rename_block(self, old_name: str, new_name: str) -> None:
        """Rename :class:`~dxfpy.layouts.BlockLayout` `old_name` to `new_name`
