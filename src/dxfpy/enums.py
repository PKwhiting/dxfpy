...
class TextHAlign(IntEnum):
    """Enumeration for DXF attribute: :attr:`dxfpy.entities.Text.dxf.halign`"""
...
class TextVAlign(IntEnum):
    """Enumeration for DXF attribute: :attr:`dxfpy.entities.Text.dxf.valign`"""
...
class TextEntityAlignment(Enum):
    """Text alignment enum for the :class:`~dxfpy.entities.Text`,
    :class:`~dxfpy.entities.Attrib` and :class:`~dxfpy.entities.AttDef`
    entities.
    """
...
class MTextEntityAlignment(IntEnum):
    """Text alignment enum for the :class:`~dxfpy.entities.MText` entity."""
