...
from dxfpy.math import UVec, Vec2, Vec3, BoundingBox2d, is_point_in_polygon_2d
from dxfpy.math.clipping import CohenSutherlandLineClipping2d
from dxfpy.math import rtree, BoundingBox
...
def bbox_inside(
    ...
    *,
    ...
    Args:
        ...
        cache: optional :class:`dxfpy.bbox.Cache` instance
