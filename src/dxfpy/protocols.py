...
if TYPE_CHECKING:
    ...
    from dxfpy.entities.temporary_transform import TemporaryTransformation
    from dxfpy.math import Matrix44, AbstractBoundingBox
...
class SupportsVirtualEntities(Protocol):
    ...
    entities. Which means the entity does not have :func:`dxfpy.path.make_path`
