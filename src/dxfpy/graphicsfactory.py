...
from dxfpy.lldxf.const import DXFValueError, DXFVersionError, DXF2000, DXF2013
...
from dxfpy.entities import factory, Point, Spline, Body, Surface, Line, Circle
from dxfpy.entities.mtext_columns import *
from dxfpy.entities.dimstyleoverride import DimStyleOverride
from dxfpy.render.dim_linear import multi_point_linear_dimension
...
if TYPE_CHECKING:
    ...
    from dxfpy.render.mleader import (
...
class CreatorInterface:
    ...
    def add_point(self, location: UVec, dxfattribs=None) -> Point:
        """
        Add a :class:`~dxfpy.entities.Point` entity at `location`.
    ...
    def add_line(self, start: UVec, end: UVec, dxfattribs=None) -> Line:
        """
        Add a :class:`~dxfpy.entities.Line` entity from `start` to `end`.
    ...
    def add_circle(
        ...
        """
        Add a :class:`~dxfpy.entities.Circle` entity. This is an 2D element,
    ...
    def add_ellipse(
        ...
        """
        Add an :class:`~dxfpy.entities.Ellipse` entity, `ratio` is the ratio of
    ...
    def add_arc(
        ...
        """
        Add an :class:`~dxfpy.entities.Arc` entity. The arc goes from
    ...
    def add_solid(self, points: Iterable[UVec], dxfattribs=None) -> Solid:
        """Add a :class:`~dxfpy.entities.Solid` entity, `points` is an iterable
        of 3 or 4 points.
    ...
    def add_trace(self, points: Iterable[UVec], dxfattribs=None) -> Trace:
        """Add a :class:`~dxfpy.entities.Trace` entity, `points` is an iterable
        of 3 or 4 points.
    ...
    def add_3dface(self, points: Iterable[UVec], dxfattribs=None) -> Face3d:
        """
        Add a :class:`~dxfpy.entities.3DFace` entity, `points` is an iterable
        3 or 4 2D/3D points.
    ...
    def add_text(
        ...
        *,
        ...
        """
        Add a :class:`~dxfpy.entities.Text` entity, see also
        :class:`~dxfpy.entities.Textstyle`.
    ...
    def add_text_acvar_field(
        ...
        *,
        ...
        """Add a :class:`~dxfpy.entities.Text` entity containing an
    ...
    def add_blockref(self, name: str, insert: UVec, dxfattribs=None) -> Insert:
        """
        Add an :class:`~dxfpy.entities.Insert` entity.
    ...
    def add_auto_blockref(
        ...
        """
        Add an :class:`~dxfpy.entities.Insert` entity. This method adds for each
        :class:`~dxfpy.entities.Attdef` entity, defined in the block definition,
        ...
        Args:
            name: block name
            insert: insert location as 2D/3D point in :ref:`WCS`
            values: :class:`~dxfpy.entities.Attrib` tag values as (tag, value) pairs
            dxfattribs: additional DXF attributes
    ...
    def add_attdef(
        ...
        *,
        ...
        """
        Add an :class:`~dxfpy.entities.AttDef` as stand alone DXF entity.
    ...
    def add_attdef_acvar_field(
        ...
        *,
        ...
        """Add an :class:`~dxfpy.entities.AttDef` containing an object-backed
        ``AcVar`` field.
        """
    ...
    def add_polyline2d(
        ...
        *,
        ...
        """
        Add a 2D :class:`~dxfpy.entities.Polyline` entity.
    ...
    def add_polyline3d(
        ...
        *,
        ...
        """Add a 3D :class:`~dxfpy.entities.Polyline` entity.
    ...
    def add_polymesh(
        ...
        """
        Add a :class:`~dxfpy.entities.Polymesh` entity, which is a wrapper class
    ...
    def add_polyface(self, dxfattribs=None) -> Polyface:
        """Add a :class:`~dxfpy.entities.Polyface` entity, which is a wrapper
        class for the POLYLINE entity.

        Args:
            dxfattribs: additional DXF attributes for
                :class:`~dxfpy.entities.Polyline` entity
    ...
    def add_shape(
        ...
        """
        Add a :class:`~dxfpy.entities.Shape` reference to an external stored shape.
    ...
    def add_lwpolyline(
        ...
        *,
        ...
        """
        Add a 2D polyline as :class:`~dxfpy.entities.LWPolyline` entity.
        ...
        The :class:`~dxfpy.entities.LWPolyline` is defined as a single DXF
        entity and needs less disk space than a
        :class:`~dxfpy.entities.Polyline` entity. (requires DXF R2000)
    ...
    def add_mtext(self, text: str, dxfattribs=None) -> MText:
        ...
        as :class:`~dxfpy.entities.MText` entity.
        (requires DXF R2000)
    ...
    def add_mtext_acvar_field(
        ...
        *,
        ...
        """Add an :class:`~dxfpy.entities.MText` entity containing an
        object-backed ``AcVar`` field.
    ...
    def add_table(
        ...
        *,
        ...
        """Add a text-only :class:`~dxfpy.entities.ACAD_TABLE` entity.
    ...
    def add_mtext_static_columns(
        ...
        :class:`~dxfpy.entities.MText` entity. The content is spread
    ...
    def add_mtext_dynamic_auto_height_columns(
        ...
        not done by `dxfpy`, therefore passing the expected column `count`
        ...
        `dxfpy`, but the result is correct for advanced DXF viewers and CAD
    ...
    def add_ray(self, start: UVec, unit_vector: UVec, dxfattribs=None) -> Ray:
        """
        Add a :class:`~dxfpy.entities.Ray` that begins at `start` point and
    ...
    def add_xline(
        ...
        """Add an infinity :class:`~dxfpy.entities.XLine` (construction line).
        (requires DXF R2000)
    ...
    def add_spline(
        ...
        """Add a B-spline (:class:`~dxfpy.entities.Spline` entity) defined by
        ...
        .. seealso::
            ...
            - :ref:`tut_spline`
            - :func:`dxfpy.math.fit_points_to_cad_cv`

        Args:
            fit_points: iterable of fit points as ``(x, y[, z])`` in :ref:`WCS`,
                creates an empty :class:`~dxfpy.entities.Spline` if ``None``
    ...
    def add_spline_control_frame(
        ...
        """Add a :class:`~dxfpy.entities.Spline` entity passing through the
    ...
    def add_open_spline(
        ...
        """
        Add an open uniform :class:`~dxfpy.entities.Spline` defined by
    ...
    def add_rational_spline(
        ...
        """
        Add an open rational uniform :class:`~dxfpy.entities.Spline` defined by
        `control_points`. (requires DXF R2000)
    ...
    def add_body(self, dxfattribs=None) -> Body:
        """Add a :class:`~dxfpy.entities.Body` entity.
    ...
    def add_region(self, dxfattribs=None) -> Region:
        """Add a :class:`~dxfpy.entities.Region` entity.
        (requires DXF R2000 or later)
    ...
    def add_3dsolid(self, dxfattribs=None) -> Solid3d:
        """Add a 3DSOLID entity (:class:`~dxfpy.entities.Solid3d`).
        (requires DXF R2000 or later)
    ...
    def add_surface(self, dxfattribs=None) -> Surface:
        """Add a :class:`~dxfpy.entities.Surface` entity.
    ...
    def add_extruded_surface(self, dxfattribs=None) -> ExtrudedSurface:
        """Add a :class:`~dxfpy.entities.ExtrudedSurface` entity.
        (requires DXF R2007 or later)
    ...
    def add_lofted_surface(self, dxfattribs=None) -> LoftedSurface:
        """Add a :class:`~dxfpy.entities.LoftedSurface` entity.
        (requires DXF R2007 or later)
    ...
    def add_revolved_surface(self, dxfattribs=None) -> RevolvedSurface:
        """
        Add a :class:`~dxfpy.entities.RevolvedSurface` entity.
        (requires DXF R2007 or later)
    ...
    def add_swept_surface(self, dxfattribs=None) -> SweptSurface:
        """
        Add a :class:`~dxfpy.entities.SweptSurface` entity.
        (requires DXF R2007 or later)
    ...
    def add_hatch(self, color: int = 7, dxfattribs=None) -> Hatch:
        """Add a :class:`~dxfpy.entities.Hatch` entity. (requires DXF R2000)
    ...
    def add_mpolygon(
        ...
        """Add a :class:`~dxfpy.entities.MPolygon` entity. (requires DXF R2000)
    ...
    def add_mesh(self, dxfattribs=None) -> Mesh:
        """
        Add a :class:`~dxfpy.entities.Mesh` entity. (requires DXF R2007)
    ...
    def add_image(
        ...
        """
        Add an :class:`~dxfpy.entities.Image` entity, requires a
        :class:`~dxfpy.entities.ImageDef` entity, see :ref:`tut_image`.
        (requires DXF R2000)

        Args:
            image_def: required image definition as :class:`~dxfpy.entities.ImageDef`
    ...
    def add_wipeout(self, vertices: Iterable[UVec], dxfattribs=None) -> Wipeout:
        """Add a :class:`dxfpy.entities.Wipeout` entity, the masking area is
    ...
    def add_underlay(
        ...
        """
        Add an :class:`~dxfpy.entities.Underlay` entity, requires a
        :class:`~dxfpy.entities.UnderlayDefinition` entity,
        see :ref:`tut_underlay`.  (requires DXF R2000)

        Args:
            underlay_def: required underlay definition as :class:`~dxfpy.entities.UnderlayDefinition`
            insert: insertion point as 3D point in :ref:`WCS`
    ...
    def add_linear_dim(
        ...
        """
        Add horizontal, vertical and rotated :class:`~dxfpy.entities.Dimension`
        line. If an :class:`~dxfpy.math.UCS` is used for dimension line rendering,
        ...
        This method returns a :class:`~dxfpy.entities.DimStyleOverride` object -
        to create the necessary dimension geometry, you have to call
        :meth:`~dxfpy.entities.DimStyleOverride.render` manually, this two-step
        process allows additional processing steps on the
        :class:`~dxfpy.entities.Dimension` entity between creation and rendering.
        ...
        Args:
            ...
            dimstyle: dimension style name (:class:`~dxfpy.entities.DimStyle`
            ...
            override: :class:`~dxfpy.entities.DimStyleOverride` attributes
            dxfattribs: additional DXF attributes for the DIMENSION entity

        Returns: :class:`~dxfpy.entities.DimStyleOverride`
    ...
    def add_multi_point_linear_dim(
        ...
        :class:`~dxfpy.math.UCS` is used for dimension line rendering, all point
        ...
        :meth:`~dxfpy.entities.DimStyleOverride.render` call.
    ...
    def add_aligned_dim(
        ...
        an :class:`~dxfpy.math.UCS` is used for dimension line rendering, all
        ...
        additional processing steps on the  :class:`~dxfpy.entities.Dimension`
    ...
    def add_angular_dim_2l(
        ...
        *,
        ...
        """
        Add angular :class:`~dxfpy.entities.Dimension` from two lines. The
        ...
        If an :class:`~dxfpy.math.UCS` is used for angular dimension rendering,
        all point definitions in UCS coordinates, translation into :ref:`WCS`
        and :ref:`OCS` is done by the rendering function. Extrusion vector is
        defined by UCS or (0, 0, 1) by default.
    ...
    def add_angular_dim_3p(
        ...
        *,
        ...
        """
        Add angular :class:`~dxfpy.entities.Dimension` from three points
    ...
    def add_angular_dim_arc(
        ...
        *,
        ...
        :class:`~dxfpy.math.ConstructionArc`. This construction tool can
        ...
        Args:
            arc: :class:`~dxfpy.math.ConstructionArc`
            distance: distance from start of the extension lines to the
                dimension line in drawing units
            location: user defined location for the text midpoint (in UCS)
            text: ``None`` or "<>" the measurement is drawn as text,
    ...
    def add_arc_dim_3p(
        ...
        *,
        ...
        """
        Add :class:`~dxfpy.entities.ArcDimension` from three points
        (center, p1, p2). Point `p1` defines the radius and the start-angle of
        the arc, point `p2` only defines the end-angle of the arc.

        If an :class:`~dxfpy.math.UCS` is used for arc dimension rendering,
        all point definitions in UCS coordinates, translation into :ref:`WCS`
        and :ref:`OCS` is done by the rendering function. Extrusion vector is
        defined by UCS or (0, 0, 1) by default.
        ...
        :meth:`~dxfpy.entities.DimStyleOverride.render` manually, this two-step
        process allows additional processing steps on the
        :class:`~dxfpy.entities.ArcDimension` entity between creation and
        rendering.
        ...
        dxfattribs["has_leader"] = 0  # ignored by dxfpy
        dxfattribs["leader_point1"] = NULLVEC  # ignored by dxfpy
        dxfattribs["leader_point2"] = NULLVEC  # ignored by dxfpy
    ...
    def add_diameter_dim(
        ...
        *,
        ...
        """
        Add a diameter :class:`~dxfpy.entities.Dimension` line. The diameter
        ...
        If an :class:`~dxfpy.math.UCS` is used for dimension line rendering,
        all point definitions in UCS coordinates, translation into :ref:`WCS`
        and :ref:`OCS` is done by the rendering function. Extrusion vector is
        defined by UCS or (0, 0, 1) by default.
        ...
        to create the necessary dimension geometry, you have to call
        :meth:`~dxfpy.entities.DimStyleOverride.render` manually, this two-step
        process allows additional processing steps on the :class:`~dxfpy.entities.Dimension`
        entity between creation and rendering.
    ...
    def add_radius_dim(
        ...
        *,
        ...
        """
        Add a radius :class:`~dxfpy.entities.Dimension` line. The radius
        dimension line requires a `center` point and a point `mpoint` on the
        circle or as an alternative a `radius` and a dimension line `angle` in
        degrees. See also: :ref:`tut_radius_dimension`

        If a :class:`~dxfpy.math.UCS` is used for dimension line rendering,
        all point definitions in UCS coordinates, translation into :ref:`WCS`
        and :ref:`OCS` is done by the rendering function. Extrusion vector is
        defined by UCS or (0, 0, 1) by default.
    ...
    def add_ordinate_dim(
        ...
        *,
        ...
        """
        Add an ordinate type :class:`~dxfpy.entities.Dimension` line. The
    ...
    def add_leader(
        ...
        """
        The :class:`~dxfpy.entities.Leader` entity represents an arrow, made up
        of one or more vertices (or spline fit points) and an arrowhead.
        The label or other content to which the :class:`~dxfpy.entities.Leader`
        is attached is stored as a separate entity, and is not part of the
        :class:`~dxfpy.entities.Leader` itself. (requires DXF R2000)

        :class:`~dxfpy.entities.Leader` shares its styling infrastructure with
        :class:`~dxfpy.entities.Dimension`.

        By default a :class:`~dxfpy.entities.Leader` without any annotation is
        ...
        Args:
            ...
            dimstyle: dimension style name (:class:`~dxfpy.entities.DimStyle`
                table entry), default is "EZDXF"
            override: override :class:`~dxfpy.entities.DimStyleOverride` attributes
            dxfattribs: additional DXF attributes
    ...
    def add_multileader_mtext(
        ...
        """Add a :class:`~dxfpy.entities.MultiLeader` entity but returns
        a :class:`~dxfpy.render.MultiLeaderMTextBuilder`.

        """
        from dxfpy.render.mleader import MultiLeaderMTextBuilder
    ...
    def add_multileader_block(
        ...
        """Add a :class:`~dxfpy.entities.MultiLeader` entity but returns
        a :class:`~dxfpy.render.MultiLeaderBlockBuilder`.

        """
        from dxfpy.render.mleader import MultiLeaderBlockBuilder
    ...
    def add_mline(
        ...
        *,
        ...
        """Add a :class:`~dxfpy.entities.MLine` entity
    ...
    def add_helix(
        ...
        """
        Add a :class:`~dxfpy.entities.Helix` entity.

        The center of the helix is always (0, 0, 0) and the helix axis direction
        is the +z-axis.

        Transform the new HELIX by the :meth:`~dxfpy.entities.DXFGraphic.transform`
