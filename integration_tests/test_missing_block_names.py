...
def test_load_r12_blocks_with_no_name():
    ...
    doc = dxfpy.readfile(DATA / "r12_blocks_with_no_names.dxf")
...
def test_load_r2000_blocks_with_recovered_names():
    ...
    """
    doc = dxfpy.readfile(DATA / "r2000_blocks_with_no_names.dxf")
...
def test_load_r2000_blocks_with_no_name_and_no_block_record():
    ...
    doc = dxfpy.readfile(DATA / "r2000_blocks_with_no_name_and_no_block_record.dxf")
    assert len(doc.blocks) == 2
    for name in ("Test", "Test2"):
